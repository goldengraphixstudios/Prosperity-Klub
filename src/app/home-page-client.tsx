...
const faqs = [
  {
    question: "What is Prosperity Klub?",
    answer: (
      <p>
        <strong>Prosperity Klub is a financial education and guidance community for
        Filipinos and OFWs.</strong> It helps people build clarity around money,
        protection, savings, and long-term wealth through education, mentorship,
        and access to trusted financial infrastructure.
      </p>
    ),
  },
  {
    question: "Is Prosperity Klub a financial company?",
    answer: (
      <p>
        No. <strong>Prosperity Klub is not a bank, insurance company, or investment
        firm.</strong> It acts as a guidance and education platform that helps
        members understand their options and connect with trusted institutions when
        needed.
      </p>
    ),
  },
  {
    ...
    answer: (
      <p>
        No. Prosperity Klub follows a <strong>guided, not sold</strong> approach.
        The first step is always understanding your goals, priorities, and current
        situation before recommending the next step that fits you best.
      </p>
    ),
  },
  {
    question: "Who is Prosperity Klub for?",
    answer: (
      <>
        <p>Prosperity Klub is designed for:</p>
        <ul className="mt-3 list-disc space-y-1 pl-5">
          <li>Filipinos who want better financial clarity</li>
          <li>OFWs planning their long-term financial future</li>
          <li>Individuals building savings and protection</li>
          <li>People looking to improve financial discipline</li>
          <li>Those who want mentorship and a supportive community</li>
        </ul>
      </>
    ),
  },
  {
    ...
    answer: (
      <p>
        Not at all. Many members start while still <strong>building their savings
        and financial discipline</strong>. Prosperity Klub focuses on education
        first so members can build a stronger foundation before taking bigger
        financial steps.
      </p>
    ),
  },
  {
    question: "What happens during a Financial Clarity Session?",
    answer: (
      <>
        <p>
          The session is a <strong>conversation focused on your financial
          priorities</strong>, not a sales presentation.
        </p>
        <ul className="mt-3 list-disc space-y-1 pl-5">
          <li>Your financial goals</li>
          <li>Your current financial situation</li>
          <li>Your priorities across protection, savings, debt, and investments</li>
          <li>Possible next steps for your situation</li>
        </ul>
      </>
    ),
  },
  {
    question: "Is Prosperity Klub connected to IMG?",
    answer: (
      <p>
        Yes. <strong>Prosperity Klub provides guidance, mentorship, and community
        support.</strong> <strong>IMG provides the financial infrastructure,
        licensed pathways, and access to partner institutions when execution is
        needed.</strong>
      </p>
    ),
  },
  {
    question: "Can I join the community without buying financial products?",
    answer: (
      <p>
        Yes. Many people join primarily for <strong>financial education,
        mentorship, and community learning.</strong> Members often start with
        improving their habits before deciding on protection or investment
        strategies.
      </p>
    ),
  },
  {
    ...
    answer: (
      <p>
        The best starting point is to <strong>book a Free Financial Clarity
        Session</strong>. You can also begin by exploring the resources and
        financial tools available on the website.
      </p>
    ),
  },
];
...
export default function HomePage() {
  ...
  return (
    <div>
          ...
          <div className="grid items-start gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            <FadeIn className="space-y-5">
              ...
              <h1 className="max-w-4xl text-4xl font-semibold leading-[0.94] text-brand-primary md:text-[4rem]">
                Financial education, guidance, and wealth-building community for
                Filipinos.
              </h1>
      ...
      <section className="pb-6 pt-16 sm:pt-20 lg:pb-10 lg:pt-24">
        <Container>
      ...
      <section className="pb-18 pt-6 sm:pt-8 lg:pt-12">
        <Container>
        ...
        <Container>
          <FadeIn className="space-y-8">
            <div className="max-w-3xl space-y-3">
              ...
              <p className="text-brand-muted">
                These answers help clarify what Prosperity Klub is, how guidance
                works, and what to expect before booking a session.
              </p>
            </div>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, index) => (
                <AccordionItem
                  key={faq.question}
                  value={`faq-${index}`}
                  className="rounded-2xl border border-brand-primary/10 bg-white/85 px-6"
                >
                  <AccordionTrigger className="text-left text-base font-semibold text-brand-primary hover:no-underline">
                    {faq.question}
                  </AccordionTrigger>
                  <AccordionContent className="pb-6 text-sm leading-7 text-brand-muted">
                    {faq.answer}
                  </AccordionContent>
                </AccordionItem>
              ))}
